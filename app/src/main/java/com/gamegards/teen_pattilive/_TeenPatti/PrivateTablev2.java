...
import static com.gamegards.teen_pattilive._TeenPatti.PublicTable.TEENPATTIPUBLIC;

public class PrivateTablev2 extends AppCompatActivity {
    ...
    txtPlay1wallet, txtPlay2wallet, txtCounttimer, txtCounttimer1, txtCounttimer2, txtCounttimer3,
            ...
            txtWaitforOther;
    Context context = PrivateTablev2.this;
...
//                        Toast.LENGTH_LONG).show();
                ...
                Funtions.showTipsDialog(PrivateTablev2.this, dealer, imgampire, new Callback() {
                    @Override
...
//    });
        ...
        imgbuychips.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PrivateTablev2.this, BuyChipsList.class);
...
//                showDialogSetting();
    ...
    private void GiftDialog(String players){
        ...
        Funtions.showGiftDialog(PrivateTablev2.this, players, new Callback() {
            @Override
...
//        }
    ...
    public void showDialoagonBack() {
        // custom dialog
        final Dialog dialog = new Dialog(PrivateTablev2.this,
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Funtions.LOGE("PrivateTablev2",""+url+"\n"+response);
...
//                                Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(PrivateTablev2.this, message, Toast.LENGTH_LONG).show();
                GameLeave("0");
    ...
    private void GameLeave(final String value) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(PrivateTablev2.this);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Funtions.LOGE("PrivateTablev2",""+Const.GAME_STATUS+"\n"+response);
                            ...
                            for (int k = 0; k < jsonArrayuser.length(); k++) {
                                if (k == 0) {
                                    ...
                                    if (user_id_player1.equals(prefs.getString("user_id", ""))) {
                                        ...
                                        Toast.makeText(PrivateTablev2.this, "Your are timeout from " +
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Const.GAME_START,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Funtions.LOGE("PrivateTablev2",""+Const.GAME_START+"\n"+response);
                        // progressDialog.dismiss();
                        try {
                            JSONObject jsonObject = new JSONObject(response);
