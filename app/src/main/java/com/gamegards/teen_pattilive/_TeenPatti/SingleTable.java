package com.gamegards.teen_pattilive._TeenPatti;
...
import com.gamegards.teen_pattilive.Fragments.Bottom_GameChating_F;
...
public class SingleTable extends AppCompatActivity{

    String TAG = "SingleTable";
    ...
    Context context = SingleTable.this;
    ...
    private ImageView imgpl1hidencard1, imgampire, imgpl1minus, imgpl1plus, imginvite2, imginvite3, imginvite4, imginvite5, imgpl1show, imgpl1pack, imgpl1chaal,
            ...
            imgpl1hidencard2, imgpl1hidencard3, imgclose, imgaccespt;
...
//                        Toast.LENGTH_LONG).show();
                ...
                Funtions.showTipsDialog(context, dealer, imgampire, new Callback() {
                    @Override
        ...
        imgpl1show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (playercount > 2) {
                    ...
                    //Toast.makeText(SingleTable.this, "Side Show Coming Soon.", Toast.LENGTH_LONG).show();
        ...
        imgblind1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               game_round++;
                ...
                editor.putInt("game_round",game_round);
                editor.apply();
...
//    });
        ...
        imgbuychips.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(SingleTable.this, BuyChipsList.class);
                startActivity(intent);
            }
        });
...
//                showDialogSetting();
    ...
    public void animationtask() {
        ...
        animMove1 = AnimationUtils.loadAnimation(SingleTable.this,
...
//                imgplayermain1.startAnimation(animMoveCardsPlayer1);
        ...
        animMove2 = AnimationUtils.loadAnimation(SingleTable.this,
...
//                imgplayer2mainfirst.startAnimation(animMoveCardsPlayer2);
        ...
        animMove3 = AnimationUtils.loadAnimation(SingleTable.this,
...
//                imgplayer3mainfirst.startAnimation(animMoveCardsPlayer3);
        ...
        animMove4 = AnimationUtils.loadAnimation(SingleTable.this,
...
//                imgplayer4mainfirst.startAnimation(animMoveCardsPlayer4);
        ...
        animMove5 = AnimationUtils.loadAnimation(SingleTable.this,
...
//                imgplayer5mainfirst.startAnimation(animMoveCardsPlayer5);
        ...
        animMove1_2 = AnimationUtils.loadAnimation(SingleTable.this,
                R.anim.movetodowntoup);
        ...
        animMove2_2 = AnimationUtils.loadAnimation(SingleTable.this,
                R.anim.movetodowntoup_corner);
        ...
        animMove3_2 = AnimationUtils.loadAnimation(SingleTable.this,
                R.anim.movetolefttoright);
        ...
        animMove4_2 = AnimationUtils.loadAnimation(SingleTable.this,
                R.anim.movetorighttoleft);
        ...
        animMove5_2 = AnimationUtils.loadAnimation(SingleTable.this,
                R.anim.movetodowntoup_corner_right_left);
        ...
        animMoveCardsPlayer1 = AnimationUtils.loadAnimation(SingleTable.this,
        ...
        animMoveCardsPlayer2 = AnimationUtils.loadAnimation(SingleTable.this,
        ...
        animMoveCardsPlayer3 = AnimationUtils.loadAnimation(SingleTable.this,
        ...
        animMoveCardsPlayer4 = AnimationUtils.loadAnimation(SingleTable.this,
        ...
        animMoveCardsPlayer5 = AnimationUtils.loadAnimation(SingleTable.this,
        ...
        animAmpireblink = AnimationUtils.loadAnimation(SingleTable.this,
                R.anim.blink);


        animMoveCardsPlayerwinner1 = AnimationUtils.loadAnimation(SingleTable.this,
                R.anim.movetoanotherwinner);
        animMoveCardsPlayerwinner2 = AnimationUtils.loadAnimation(SingleTable.this,
                R.anim.movetoanotherleftcornerwinner);

        animMoveCardsreferycomi = AnimationUtils.loadAnimation(SingleTable.this,
        ...
        animMoveCardsPlayerwinner3 = AnimationUtils.loadAnimation(SingleTable.this,
                R.anim.movetorighttoleftcardswinner);

        animMoveCardsPlayerwinner4 = AnimationUtils.loadAnimation(SingleTable.this,
                R.anim.movetolefttorightcardnewwinner);

        animMoveCardsPlayerwinner5 = AnimationUtils.loadAnimation(SingleTable.this,
...
//        txtTotalCoin.startAnimation(animMove2);
    ...
    private void UpdateWalletBallance(String user_id, String wallet) {
        if (user_id.equals(user_id_player1)) {
            ...
            //  txtPlay2wallet.setText("₹"+wallet);

        } else if (user_id.equals(user_id_player3)) {

            //txtPlay3wallet.setText("₹"+wallet);
            long numberamount = Long.parseLong(wallet);
    ...
    public void makeWinnertoPlayer(String chaal_user_id) {
        ...
        int valueforrefery = Integer.parseInt(game_amount);
        int referycom = valueforrefery * 2 / 100;
    ...
    public void makeslidshow(String user_id_temp, String name) {
        ...
        if (user_id_temp.equals(user_id_player1)) {
            ...
            rltslidshow.setVisibility(View.VISIBLE);
...
//        }
    ...
    public void makegone() {
        ...
        Picasso.get().load(imageResource1).into(imgpl2hidencard1);
        Picasso.get().load(imageResource1).into(imgpl2hidencard2);
        Picasso.get().load(imageResource1).into(imgpl2hidencard3);
    ...
    public void showDialoagonBack() {
        // custom dialog
        final Dialog dialog = new Dialog(SingleTable.this,
        ...
        switchd.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                if (isChecked) {
                    ...
                    // Toast.makeText(SingleTable.this, "On", Toast.LENGTH_LONG).show();

                } else {
                    // Toast.makeText(SingleTable.this, "Off", Toast.LENGTH_LONG).show();
                    SharedPreferences.Editor editor = getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE).edit();
        ...
        try {
            ...
            if (code.equalsIgnoreCase("200")) {
                ...
                if (jsonObject.has("table_data")) {
                    ...
                    //  String message = jsonObject.getString("message");
//                        Toast.makeText(SingleTable.this, message,
//                                Toast.LENGTH_LONG).show();
                    //  }
                ...
                Toast.makeText(SingleTable.this, message, Toast.LENGTH_LONG).show();
                GameLeave("0");
    ...
    private void GameLeave(final String value) {
        ...
        final ProgressDialog progressDialog = new ProgressDialog(SingleTable.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Const.GAME_TABLE_LEAVE,
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.dismiss();
                // Toast.makeText(SingleTable.this, "Something went wrong", Toast.LENGTH_LONG)
                // .show();
            }
        }) {
            @Override
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Const.GAME_STATUS,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Funtions.LOGE("Public_Table",""+Const.GAME_STATUS+"\n"+response);
                            ...
                            for (int k = 0; k < jsonArrayuser.length(); k++) {
                                if (k == 0) {
                                    ...
                                    if (user_id_player1.equals(prefs.getString("user_id", ""))) {
                                        ...
                                        Toast.makeText(SingleTable.this, "Your are timeout from " +
...
//second player
                                    ...
                                    if (user_id_player3.equals("0")) {
                                        ...
                                        long numberamount = Long.parseLong(walletplayer3);
                                        txtPlay3wallet.setText("" + NumberFormat.getNumberInstance(Locale.US).format(numberamount));
...
//third player
                                    ...
                                    if (user_id_player4.equals("0")) {
                                        ...
                                        long numberamount = Long.parseLong(walletplayer4);
                                        txtPlay4wallet.setText("" + NumberFormat.getNumberInstance(Locale.US).format(numberamount));
                                    ...
                                    if (walletplayer5.equals("0")) {
                                        ...
                                        long numberamount = Long.parseLong(walletplayer5);
                                        txtPlay5wallet.setText("" + NumberFormat.getNumberInstance(Locale.US).format(numberamount));
                            ...
                            if (jsonObject.has("active_game_id")) {
                                ...
                                Log.d("gamestatus", "onResponse: "+game_status);
                            ...
                            if (jsonObject.has("game_amount")) {
                                ...
                                txtTotalCoin.setVisibility(View.VISIBLE);
                                txtTotalCoin.setText("₹" + game_amount);
                            } else {
                            ...
                            JSONArray jsonArrayall_slide_show = jsonObject.getJSONArray(
                                    "slide_show");
                            if (jsonArrayall_slide_show.length() > 0) {

                                JSONObject json_obj_slid = jsonArrayall_slide_show.getJSONObject(0);
                                ...
                                rltslidshow.setVisibility(View.GONE);
                                txtSlidshow.setVisibility(View.GONE);
                            ...
                            if (table_amount.length() > 0 && chaal_limit.length() > 0) {
                                ...
                                int inttableamount = Integer.parseInt(table_amount);
                                int intchaal_limit = Integer.parseInt(chaal_limit);
...
//        }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (code.equals("200")) {
                                ...
                                // Toast.makeText(SingleTable.this, message, Toast.LENGTH_LONG)
                                // .show();
    ...
    private void GameChhal() {
        ...
        if (sentamounttype.equals("1")) {
            ...
            txt_coin_to_girl_player1.setText("₹" + updatedamount);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (code.equalsIgnoreCase("200")) {
                                ...
                                if (jsonObject.has("message")) {
                                    String message = jsonObject.getString("message");
                                    //Toast.makeText(SingleTable.this, message, Toast
                                    // .LENGTH_LONG).show();
                                }
                        ...
                        try {
                            ...
                            if (code.equalsIgnoreCase("200")) {
                                ...
                                if (jsonObject.has("cards")) {
                                    ...
                                    if (jsonObject.has("message")) {
                                        String message = jsonObject.getString("message");
//                                        Toast.makeText(SingleTable.this, "Wrong mobile number or password",
//                                                Toast.LENGTH_LONG).show();
                                    }
                        ...
                        try {
                            ...
                            if (code.equalsIgnoreCase("200")) {
                                ...
                                if (jsonObject.has("cards")) {
                                    ...
                                    Picasso.get().load(imageResource1).into(imgpl2hidencard1);
                                    Picasso.get().load(imageResource2).into(imgpl2hidencard2);
                                    Picasso.get().load(imageResource3).into(imgpl2hidencard3);
...
//        }
    ...
    private void showGiftDialog(String players){
        ...
        Funtions.showGiftDialog(context, players, new Callback() {
            @Override
...
//                }
    ...
    private void Parse_Response(String resp,String playerno,String gifturl) throws JSONException {
        ...
        if (code.equalsIgnoreCase("200")) {
            ...
            // Toast.makeText(SingleTable.this, ""+message, Toast.LENGTH_SHORT).show();
