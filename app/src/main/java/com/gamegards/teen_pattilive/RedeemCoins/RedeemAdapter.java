package com.gamegards.teen_pattilive.RedeemCoins;
...
import com.gamegards.teen_pattilive.Chips.ChipsBuyModel;
            ...
            public void Responce(String resp, String type, Bundle bundle) {
                ...
                try {
                    ...
                    if (message.equals("1")) {
                        ...
                        CommonFunctions.showAlertDialog(context,"Alert message","Please Fill the Profile First",true,"Ok", new DialogInterface.OnClickListener() {
                            @Override
