package com.gamegards.teen_pattilive.Fragments;
...
import static com.gamegards.teen_pattilive._TeenPatti.PublicTable.MY_PREFS_NAME;
...
//        final AlertDialog dialog = builder.create();
    ...
    public void redeem(final String mob,final String amount){
        ...
        ApiRequest.Call_Api(context, Const.redeem, params, new Callback() {
            @Override
