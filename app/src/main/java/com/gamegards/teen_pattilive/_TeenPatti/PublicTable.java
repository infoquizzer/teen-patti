...
public class PublicTable extends AppCompatActivity {

    String TAG = "PublicTable";
    ...
    Context context = PublicTable.this;
        ...
        imgpl1show.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (playercount > 2) {
                    ...
                    //Toast.makeText(PublicTable.this, "Side Show Coming Soon.", Toast.LENGTH_LONG).show();
...
//    });
        ...
        imgbuychips.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PublicTable.this, BuyChipsList.class);
                startActivity(intent);
            }
        });
...
//                showDialogSetting();
    ...
    public void animationtask() {
        ...
        animMove1 = AnimationUtils.loadAnimation(PublicTable.this,
...
//                imgplayermain1.startAnimation(animMoveCardsPlayer1);
        ...
        animMove2 = AnimationUtils.loadAnimation(PublicTable.this,
...
//                imgplayer2mainfirst.startAnimation(animMoveCardsPlayer2);
        ...
        animMove3 = AnimationUtils.loadAnimation(PublicTable.this,
...
//                imgplayer3mainfirst.startAnimation(animMoveCardsPlayer3);
        ...
        animMove4 = AnimationUtils.loadAnimation(PublicTable.this,
...
//                imgplayer4mainfirst.startAnimation(animMoveCardsPlayer4);
        ...
        animMove5 = AnimationUtils.loadAnimation(PublicTable.this,
...
//                imgplayer5mainfirst.startAnimation(animMoveCardsPlayer5);
        ...
        animMove1_2 = AnimationUtils.loadAnimation(PublicTable.this,
                R.anim.movetodowntoup);
        ...
        animMove2_2 = AnimationUtils.loadAnimation(PublicTable.this,
                R.anim.movetodowntoup_corner);
        ...
        animMove3_2 = AnimationUtils.loadAnimation(PublicTable.this,
                R.anim.movetolefttoright);
        ...
        animMove4_2 = AnimationUtils.loadAnimation(PublicTable.this,
                R.anim.movetorighttoleft);
        ...
        animMove5_2 = AnimationUtils.loadAnimation(PublicTable.this,
                R.anim.movetodowntoup_corner_right_left);
        ...
        animMoveCardsPlayer1 = AnimationUtils.loadAnimation(PublicTable.this,
        ...
        animMoveCardsPlayer2 = AnimationUtils.loadAnimation(PublicTable.this,
        ...
        animMoveCardsPlayer3 = AnimationUtils.loadAnimation(PublicTable.this,
        ...
        animMoveCardsPlayer4 = AnimationUtils.loadAnimation(PublicTable.this,
        ...
        animMoveCardsPlayer5 = AnimationUtils.loadAnimation(PublicTable.this,
        ...
        animAmpireblink = AnimationUtils.loadAnimation(PublicTable.this,
                R.anim.blink);


        animMoveCardsPlayerwinner1 = AnimationUtils.loadAnimation(PublicTable.this,
                R.anim.movetoanotherwinner);
        animMoveCardsPlayerwinner2 = AnimationUtils.loadAnimation(PublicTable.this,
                R.anim.movetoanotherleftcornerwinner);

        animMoveCardsreferycomi = AnimationUtils.loadAnimation(PublicTable.this,
        ...
        animMoveCardsPlayerwinner3 = AnimationUtils.loadAnimation(PublicTable.this,
                R.anim.movetorighttoleftcardswinner);

        animMoveCardsPlayerwinner4 = AnimationUtils.loadAnimation(PublicTable.this,
                R.anim.movetolefttorightcardnewwinner);

        animMoveCardsPlayerwinner5 = AnimationUtils.loadAnimation(PublicTable.this,
...
//        }
    ...
    public void showDialoagonBack() {
        // custom dialog
        final Dialog dialog = new Dialog(PublicTable.this,
...
//                                Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(PublicTable.this, message, Toast.LENGTH_LONG).show();
                GameLeave("0");
                            ...
                            for (int k = 0; k < jsonArrayuser.length(); k++) {
                                if (k == 0) {
                                    ...
                                    if (user_id_player1.equals(prefs.getString("user_id", ""))) {
                                        ...
                                        Toast.makeText(PublicTable.this, "Your are timeout from " +
